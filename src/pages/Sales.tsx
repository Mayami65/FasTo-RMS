...
import { Search, RotateCcw, Eye, Calendar, PencilLine } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
...
export default function Sales() {
  ...
  const handleEditSale = async (saleId: number) => {
    try {
      ...
      navigate("/pos", { state: { editSale: saleData } });
    } catch (error) {
