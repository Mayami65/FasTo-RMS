        ...
        <Card className="border-none shadow-[0_20px_50px_rgba(0,0,0,0.1)] overflow-hidden bg-white">
          ...
          <CardContent className="pb-8 px-8">
            <form onSubmit={handleLogin} className="space-y-5">
              {error && (
                <Alert
                  variant="destructive"
                  className="bg-red-50 border-red-200 text-red-700 animate-in fade-in slide-in-from-top-1"
                >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  disabled={loading}
                  className="h-11 bg-slate-50/50 border-slate-200 text-slate-900 caret-slate-900 placeholder:text-slate-400 dark:text-slate-900 dark:caret-slate-900 focus:ring-2 focus:ring-[#1e1b4b]/10 focus:border-[#1e1b4b] transition-all"
                  autoFocus
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Input
                    ...
                    disabled={loading}
                    className="h-11 pr-10 bg-slate-50/50 border-slate-200 text-slate-900 caret-slate-900 placeholder:text-slate-400 dark:text-slate-900 dark:caret-slate-900 focus:ring-2 focus:ring-[#1e1b4b]/10 focus:border-[#1e1b4b] transition-all"
                  />
                  <button
                    type="button"
          ...
          <div className="py-3 px-6 bg-slate-50/80 border-t border-slate-100 text-center">
            <p className="text-[11px] font-medium text-slate-500 uppercase tracking-widest leading-relaxed">
              FasTo RMS &bull; Version 1.0.0 &bull; Secure Enterprise Retail
              Platform
            </p>
          </div>
        </Card>
