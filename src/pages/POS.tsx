...
function POSContent() {
    ...
    const handleResumeSale = async (heldSale: any) => {
        if (cart.length > 0) {
            if (!confirm("Your current cart is not empty. Resuming will overwrite it. Continue?")) {
                return;
            }
        }
    ...
    const handleConfirmSale = async (paymentData: {
        ...
        const saleData = {
            ...
            depositAmount: paymentData.paymentMethod === 'HIRE_PURCHASE' ? paymentData.amountTendered : undefined,
        ...
        if (result.success) {
            ...
            const receiptData = {
                ...
                change: paymentData.amountTendered - (totalAmount - (paymentData.discount_amount || 0)),
                ...
                <div className="flex-[0.3] min-w-[380px] flex flex-col">
                    ...
                    <div className="mt-4 flex gap-1.5 px-0.5">
                        ...
                        >
                            ...
                            {!hasRefunds && <Badge variant="outline" className="absolute -top-1 -right-1 bg-white text-[8px] px-1 font-black">PRO</Badge>}
                        </Button>
                        <Button
                            variant="outline"
